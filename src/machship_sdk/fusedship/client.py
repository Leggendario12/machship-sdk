"""Synchronous FusedShip client implementation."""
...
class FusedShipClient:
    """
    A synchronous client for the FusedShip API.
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize the FusedShip client.
    ...
    @classmethod
    def from_env(cls, **kwargs: Any) -> "FusedShipClient":
        """
        ...
        Returns:
            A new FusedShipClient instance.
        """
    ...
    def __enter__(self) -> "FusedShipClient":
    ...
    def _request(
        ...
        *,
        ...
        """
        Perform an internal HTTP request to the FusedShip API.
    ...
    def request(
        ...
        *,
        ...
        """
        Perform an HTTP request to the FusedShip API.
