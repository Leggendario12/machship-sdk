"""Synchronous MachShip client implementation."""
...
from .retries import RetryPolicy, run_sync_with_retry
...
class MachShipClient:
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize the MachShip client.

        Args:
            config: The client configuration.
            client: An optional HTTPX client to use.
            transport: An optional HTTPX transport to use.
    ...
    @classmethod
    def from_env(cls, **kwargs: Any) -> "MachShipClient":
    ...
    def __enter__(self) -> "MachShipClient":
    ...
    def ping(self) -> BooleanBaseDomainEntityV2:
    ...
    def get_available_carriers_accounts_and_services(
        self,
        *,
    ...
    def get_rates(self, request: RouteRequestV2) -> RoutesResponseV2BaseDomainEntityV2:
        """Alias for return_routes.

        Args:
            request: The route request details.
        """
        return self.return_routes(request)

    def return_multiple_routes(
        self,
    ...
    def return_routes_with_complex_items(
        self,
    ...
    def get_rates_with_complex_items(
        self,
        request: RouteRequestComplexItemsV2,
    ) -> RoutesResponseV2BaseDomainEntityV2:
        ...
        Args:
            request: The route request details with complex items.
        """
        return self.return_routes_with_complex_items(request)
    ...
    def create_shipment(
        ...
        Args:
            request: The consignment creation details.
        """
        return self.create_consignment(request)

    def create_consignment_with_complex_items(
        self,
    ...
    def return_consignment_statuses(
        self,
        *,
    ...
    def update_consignment_statuses(
        self,
    ...
    def get_consignment_pdf(self, consignment_id: int) -> bytes:
    ...
    def get_label_pdf(self, consignment_id: int) -> bytes:
        """Alias for get_consignment_pdf.

        Args:
            consignment_id: The ID of the consignment.
        """
        return self.get_consignment_pdf(consignment_id)

    def get_consignment_pdf_file_info(
        self,
        consignment_id: int,
    ) -> FileInfoBaseDomainEntityV2:
    ...
    def get_label_file_info(self, consignment_id: int) -> FileInfoBaseDomainEntityV2:
        """Alias for get_consignment_pdf_file_info.

        Args:
            consignment_id: The ID of the consignment.
        """
        return self.get_consignment_pdf_file_info(consignment_id)

    def get_manifest_pdf(self, manifest_id: int) -> bytes:
    ...
    def get_manifest_pdf_file_info(
        self,
        manifest_id: int,
    ) -> FileInfoBaseDomainEntityV2:
    ...
    def group_consignments_for_manifest(
        self,
    ...
    def group_all_unmanifested_consignments_for_manifest(
        self,
        company_id: int,
    ) -> BookedManifestV2ICollectionBaseDomainEntityV2:
    ...
    def list_company_locations(
        ...
        *,
        ...
        Args:
            company_id: Optional company ID filter.
        """
        return self.get_company_locations(company_id=company_id)
    ...
    def get_company_location_permanent_pickups(
        self,
        location_id: int,
    ) -> CompanyLocationV2PermanentPickupsBaseDomainEntityV2:
